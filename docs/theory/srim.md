...
We begin with discrete-time state equations that correspond to the structure's dynamics (see [Discrete LTI State-Space Representation](https://brace2.github.io/mdof/theory/statespace.html#discrete-lti-state-space-representation)).
